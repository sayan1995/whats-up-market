...
<div id="product-grid" style="width:750px; margin-left:220px;margin-top:-420px;">
...
<div class="container" style="width:900px;margin-left:-15px;">
	...
	$temp="";
	$count=0;
	$temp_array = $db_handle->runQuery("SELECT * FROM items WHERE Item_Name LIKE '".$search_item."'");
    $product_array=array();
